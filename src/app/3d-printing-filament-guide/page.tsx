  ...
  return (
    <>
      ...
      <main id="main-content" className="pt-20">
        ...
        <section aria-label="Page introduction" className="pt-20 pb-16 px-6" style={{ background: 'var(--surface-1)' }}>
          <div className="max-w-5xl mx-auto">
            <div style={{ fontFamily: 'var(--font-display)', color: 'var(--brand-primary)', fontSize: '0.75rem', letterSpacing: '0.05em' }} className="uppercase font-semibold mb-4">
              ...
              <span style={{ color: 'var(--muted-foreground)' }}>3D Printing Filament Guide</span>
            </div>
            <h1 style={{ fontFamily: 'var(--font-display)', color: 'var(--foreground)', lineHeight: 1.05 }} className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              3D printing <span style={{ color: 'var(--brand-primary)' }}>filament guide.</span>
            </h1>
        ...
        <section aria-label="Filament settings reference table" className="py-20 px-6" style={{ background: 'var(--surface-0)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <div style={{ border: '1px solid var(--border)', borderRadius: '0.25rem', overflow: 'hidden', fontVariantNumeric: 'tabular-nums' }}>
              <div style={{ background: 'var(--surface-2)', padding: '0.625rem 1rem', display: 'grid', gridTemplateColumns: '110px 130px 130px 130px 110px 1fr', gap: '0.75rem' }}>
                {['Material', 'Print Temp', 'Bed Temp', 'Enclosure', 'Difficulty', 'Best For'].map((h) => (
                  <span key={h} style={{ fontFamily: 'var(--font-display)', color: 'var(--muted-foreground)', letterSpacing: '0.1em', fontSize: '0.65rem' }} className="uppercase font-semibold">
                    {h}
                  </span>
                ))}
              </div>
              {materials.map((m, i) => (
                ...
                >
                  <span style={{ fontFamily: 'var(--font-display)', color: 'var(--brand-primary)' }} className="text-sm font-semibold">{m.name}</span>
                  <span style={{ fontFamily: 'var(--font-display)', color: 'var(--foreground)' }} className="text-sm">{m.printTemp}</span>
                  <span style={{ fontFamily: 'var(--font-display)', color: 'var(--foreground)' }} className="text-sm">{m.bedTemp}</span>
                  <span style={{ ...bodyStyle }} className="text-sm">{m.enclosure}</span>
                  <span style={{ fontFamily: 'var(--font-display)', color: 'var(--brand-primary)' }} className="text-xs uppercase font-semibold">{m.difficulty}</span>
        ...
        {/* PLA */}
        <section aria-label="PLA filament overview" className="py-20 px-6" style={{ background: 'var(--surface-1)' }}>
          <div className="max-w-5xl mx-auto">
            <Eyebrow>PLA</Eyebrow>
        ...
        {/* PETG */}
        <section aria-label="PETG filament overview" className="py-20 px-6" style={{ background: 'var(--surface-0)' }}>
          <div className="max-w-5xl mx-auto">
        ...
        {/* ABS */}
        <section aria-label="ABS filament overview" className="py-20 px-6" style={{ background: 'var(--surface-1)' }}>
          <div className="max-w-5xl mx-auto">
            <Eyebrow>ABS</Eyebrow>
        ...
        {/* ASA */}
        <section aria-label="ASA filament overview" className="py-20 px-6" style={{ background: 'var(--surface-0)' }}>
          <div className="max-w-5xl mx-auto">
            <Eyebrow>ASA</Eyebrow>
        ...
        {/* Nylon */}
        <section aria-label="Nylon filament overview" className="py-20 px-6" style={{ background: 'var(--surface-1)' }}>
          <div className="max-w-5xl mx-auto">
        ...
        {/* TPU */}
        <section aria-label="TPU filament overview" className="py-20 px-6" style={{ background: 'var(--surface-0)' }}>
          <div className="max-w-5xl mx-auto">
            <Eyebrow>TPU</Eyebrow>
        ...
        {/* Resin */}
        <section aria-label="Resin overview" className="py-20 px-6" style={{ background: 'var(--surface-1)' }}>
          <div className="max-w-5xl mx-auto">
        ...
        {/* Decision flowchart */}
        <section aria-label="How to choose your filament" className="py-20 px-6" style={{ background: 'var(--surface-0)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <div style={{ border: '1px solid var(--border)', borderRadius: '0.25rem', overflow: 'hidden' }}>
              <div style={{ background: 'var(--surface-2)', padding: '0.625rem 1.25rem', display: 'grid', gridTemplateColumns: '1fr 240px' }}>
                <span style={{ fontFamily: 'var(--font-display)', color: 'var(--muted-foreground)', letterSpacing: '0.1em', fontSize: '0.65rem' }} className="uppercase font-semibold">Question</span>
                <span style={{ fontFamily: 'var(--font-display)', color: 'var(--muted-foreground)', letterSpacing: '0.1em', fontSize: '0.65rem' }} className="uppercase font-semibold">Answer</span>
              </div>
              {decisionRows.map((row, i) => (
                ...
                >
                  ...
                  <span style={{ fontFamily: 'var(--font-display)', color: 'var(--brand-primary)' }} className="text-sm font-semibold">{row.a}</span>
                </div>
              ))}
            </div>
