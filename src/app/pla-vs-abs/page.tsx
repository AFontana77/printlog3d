      ...
      <main id="main-content" className="pt-20">
        ...
        <section aria-label="Page introduction" className="py-16 px-4" style={{ backgroundColor: '#F5F3FF' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 text-lg leading-relaxed max-w-2xl">
              ABS was the default strong filament before PETG existed. Many beginners assume they'll need to
              upgrade to ABS eventually. Most won't. Here is why — and when ABS actually makes sense.
            </p>
          </div>
        </section>
        ...
        <section aria-label="PLA vs ABS comparison table" className="py-14 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">PLA vs ABS: Key Differences</h2>
        ...
        <section aria-label="Why most printers don't need ABS" className="py-14 px-4 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Why Most People Don't Need ABS</h2>
        ...
        <section aria-label="The better filament upgrade path" className="py-14 px-4 bg-white">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">The Upgrade Path That Actually Makes Sense</h2>
        ...
        <section aria-label="When ABS is the correct material" className="py-14 px-4 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">When ABS Is the Right Answer</h2>
        ...
        <section aria-label="PLA strengths worth remembering" className="py-14 px-4 bg-white">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">PLA Strengths People Forget</h2>
        ...
        <section aria-label="Download the app" className="py-16 px-4 bg-white">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              Log your PLA and ABS print settings in PrintLog3D.
            </h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Compare results across brands. Find your settings baseline and go back to it any time. Free.
            </p>
            <Link
              href="/free-download"
